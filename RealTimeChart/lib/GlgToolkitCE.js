...
tproto.SetCustomSetupHandler = function( handler ) { this.glg_handle._SetCustomSetupHandler( handler ); }
tproto.AddHandler = function( handler_name, handler ) { this.glg_handle._AddHandler( handler_name, handler ); }
tproto.SetHandlerData = function( viewport, data ) { this.glg_handle._SetHandlerData( viewport, data ); }
tproto.GetHandlerData = function( viewport ) { return this.glg_handle._GetHandlerData( viewport ); }
tproto.CreateMessage = function( viewport ) { return this.glg_handle._CreateMessage( viewport ); }
tproto.SendMessageToParent = function( viewport, message_obj, action, sub_action ) { return this.glg_handle._SendMessageToParent( viewport, message_obj, action, sub_action ); }
tproto.GetNativeEventType = function( call_event ) { return this.glg_handle._GetNativeEventType( call_event ); }
tproto.GetNativeEventXY = function( call_event, y_coord ) { return this.glg_handle._GetNativeEventXY( call_event, y_coord ); }
tproto.GetNativeEventKey = function( call_event ) { return this.glg_handle._GetNativeEventKey( call_event ); }
...
tproto.CreateGlgHandler = function( handler ) { return this.glg_handle._CreateGlgHandler( handler ); }
tproto.CreateCustomSetupHandler = function( handler ) { return this.glg_handle._CreateCustomSetupHandler( handler ); }
...
oproto.UpdateChartTimeAxis = function( res_name, time_stamp, initialize ) { return this.glg_handle._UpdateChartTimeAxis( this.obj, res_name, time_stamp, initialize ); }
...
oproto.GetObjectViewport = function( heavy_weight, self ) { return this.glg_handle._GetObjectViewport( this.obj, heavy_weight, self ); }
...
oproto.FindObjects = function( match_type, find_parents, include_top_object, find_first_match, search_inside, search_drawable_only, object_type, object_name, resource_name, object_id, custom_match, search_templates, dont_add_matches ) { return this.glg_handle._FindObjects( this.obj, match_type, find_parents, include_top_object, find_first_match, search_inside, search_drawable_only, object_type, object_name, resource_name, object_id, custom_match, search_templates, dont_add_matches ); }
...
oproto.SetObjectData = function( data ) { this.glg_handle._SetObjectData( this.obj, data ); }
oproto.GetObjectData = function( ) { return this.glg_handle._GetObjectData( this.obj, ); }
 tproto. MAJOR_VERSION = 4;
 tproto. MINOR_VERSION = 4;
...
tproto.GlgCallEventType = new function(){
   ...
   this.HI_RESETUP_EVENT = 2;
   this.CLEANUP_EVENT = 3;
   this.MESSAGE_EVENT = 4;
   this.DI_SETUP_EVENT = 5;
   this.CHANGE_EVENT = 6;
   this.NATIVE_EVENT = 7;
   this.MESSAGE_ACTION = 8;
};
...
tproto.GlgAxisType = new function(){
   ...
   this.LOCAL_TIME_SWEEP_AXIS = 16;
   this.UTC_TIME_SWEEP_AXIS = 17;
   this.REL_TIME_SWEEP_AXIS = 18;
   this.INDEX_SWEEP_AXIS = 19;
   this.REL_INDEX_SWEEP_AXIS = 20;
...
tproto.GlgHierarchyCallbackType = new function(){
   ...
   this.AFTER_SETUP_CB = 2;
   this.FINISHED_SETUP_CB = 3;
   this.BEFORE_RESET_CB = 4;
   this.AFTER_RESET_CB = 5;
};
tproto.GlgCustomSetupType = new function(){
   this.BEFORE_HI_SETUP = 1;
   this.AFTER_HI_SETUP = 2;
   this.FINISHED_SETUP = 3;
   this.BEFORE_RESET_SETUP = 4;
   this.AFTER_RESET_SETUP = 5;
};
